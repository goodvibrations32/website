...
** documentation
There is a primitive man page for the basic and also the README has the "starting stuff"... Online resources are available and equivalent and building instructions are in both places for ease. [[file:experiments_instructions.org][The web version]] will be available in hard copy form (on pdf or something for storage but you could download html also!).
** schematics and pcb design
:properties:
:custom_id: sch_and_pcb_experiments
:end:
